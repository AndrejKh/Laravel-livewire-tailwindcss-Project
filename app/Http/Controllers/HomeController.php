...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('home.home', compact('carousel_banners', 'categories', 'principal_categories','products','brands', 'banners_promotionals'));
    }
    ...
    public function vitrinaPorCategoria(Request $request)
    {
        ...
        if( isset($request->slug) ){
            ...
            if( isset($request->state) ){
                ...
                $products = Product::inRandomOrder()->where('status', 'active')->where('category_id', $category_selected->id)->get();
                $total_products_search = $products->count();
