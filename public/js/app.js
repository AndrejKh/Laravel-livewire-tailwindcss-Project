...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll('.shoppingCarButtonOpenModal').forEach(function (item) {
    item.addEventListener('click', function (event) {
      ...
      brandSelectedInBrandDetailView = localStorage.getItem('brandSelectedInBrandDetailView'); //  obtengo el contenedor donde se mostrara la marca seleccionada
      ...
      if (brandSelectedInBrandDetailView !== null) {
        ...
        brandSelected = JSON.parse(brandSelectedInBrandDetailView); // creo un clon del card de ejemplo

        newCardBrandShoppingCar = cardBrandShoppingCar.firstElementChild.cloneNode(true); // Obtengo los campos del card  clonado
        ...
        newAddress.textContent = brandSelected.address; // Inserto el card en el modal

        containerBrandShoppingCar.appendChild(newCardBrandShoppingCar); // agrego el nombre de la tienda donde se esta comprando

        document.getElementById('titleBrandInShoppingCar').textContent = brandSelected.title; // Muestro la tienda
      ...
      if (ProductsLocalStorage !== null) {
        ...
        arrayProductsLocalStorage.forEach(function (product) {
          ...
          if (brandSelectedInBrandDetailView !== null) {
            newPrice.textContent = "".concat(product.price, " USD$");
      ...
      if (deleteBrandDetailInShoppingCar !== null) {
        deleteBrandDetailInShoppingCar.addEventListener('click', function (event) {
          ...
          document.getElementById('brandInShoppingCar').setAttribute("hidden", true); // verifico si hay produtos en el carrito
          // Obtengo los productos del local storage
      ...
      finalizarCompra.addEventListener('click', function (event) {
        ...
        var brandSelectedInBrandDetailView = localStorage.getItem('brandSelectedInBrandDetailView');
        var brand = JSON.parse(brandSelectedInBrandDetailView);

        if (brandSelectedInBrandDetailView !== null) {
          // Obtengo los productos del local storage
          var _ProductsLocalStorage = localStorage.getItem('productsShoppingCar');

          var products = JSON.parse(_ProductsLocalStorage); // // Obtengo loa ubicacion del local storage
          ...
          var itemsSelected = localStorage.getItem('itemsSelected');
          var items = JSON.parse(itemsSelected);
  ...
  if (addProduct !== null) {
    ...
    addProduct.addEventListener('click', function () {
      ...
      if (ProductsLocalStorage === null) {
        ...
        var _brandSelectedInBrandDetailView = localStorage.getItem('brandSelectedInBrandDetailView'); // veo si existe tal tienda


        if (_brandSelectedInBrandDetailView !== null) {
        ...
        var _ProductsLocalStorage2 = '[' + JSON.stringify(newProduct) + ']'; // Muestro el span que indica que hay producots en el carrito


        updateTotalProductsShoppingCar(JSON.parse(_ProductsLocalStorage2));
        shownHideCompareFloatButton(arrayProductsLocalStorage); // Almaceno el producto en el localStorage

        localStorage.setItem('productsShoppingCar', _ProductsLocalStorage2); // El carrito tiene productos
      } else {
        arrayProductsLocalStorage = JSON.parse(ProductsLocalStorage);
        ...
        if (productInShppingCar) {
          ...
          var _brandSelectedInBrandDetailView2 = localStorage.getItem('brandSelectedInBrandDetailView'); // veo si existe tal tienda


          if (_brandSelectedInBrandDetailView2 !== null) {
            ...
            if (_priceProductDetailBrandView !== null) {
              var _price = _priceProductDetailBrandView.textContent;
              _newProduct = {
                id: idProduct,
                title: titleProduct,
                quantity: quantity,
          ...
          updateTotalProductsShoppingCar(arrayProductsLocalStorage);
          shownHideCompareFloatButton(arrayProductsLocalStorage); // Agrego el precio del producto, en caso de tener una tienda seleccionada y estar en la vista de detalles del producto de la tienda
      ...
      document.querySelectorAll('.removeProductModalShoppingCar').forEach(function (item) {
        item.addEventListener('click', function (event) {
          ...
          if (productInShppingCar) {
            ...
            var _brandSelectedInBrandDetailView3 = localStorage.getItem('brandSelectedInBrandDetailView');

            if (_brandSelectedInBrandDetailView3 !== null) {
              var brand = JSON.parse(_brandSelectedInBrandDetailView3); // Obtengo los productos del DOM
...
function updateAmount() {
  ...
  if (brandSelectedInBrandDetailView !== null) {
    ...
    amountShoppingCar.textContent = "".concat(amount, " USD$");
  }
}
