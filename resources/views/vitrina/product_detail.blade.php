        ...
        <div class="max-w-7xl w-full px-2">
            <div class="grid grid-cols-1 md:grid-cols-6 gap-3">
                <div class="block md:hidden max-w-7xl col-span-1">
                    <h1 class="text-xl md:text-2xl text-gray-900 font-bold mb-1 md:mb-5 lg:mb-6" id="titleProduct">
                        {{ $product->title }}
                    </h1>
                ...
                <div class="max-w-7xl col-span-1 md:col-span-3 rounded-xl shadow-md overflow-hidden relative h-64 md:h-auto mx-2 md:mx-0" style="background-color:#fff!important;">
