...
@section('header')
    ...
    <meta property="og:url" content="https://kabasto.com/supermercado/{{$brand->brand}}/{{$product->slug}}">
    ...
    {{-- url canonical --}}
    <link rel="canonical" href="https://kabasto.com/supermercado/{{$brand->brand}}/{{$product->slug}}" />
@endsection
...
@section('content')
    ...
    <div class="flex justify-center mt-3">
        <div class="max-w-7xl w-full px-2">
            <div class="grid grid-cols-1 md:grid-cols-6 gap-3">
                ...
                <div class="max-w-7xl col-span-1 md:col-span-3 rounded-xl shadow-md overflow-hidden relative h-64 md:h-auto mx-2 md:mx-4" style="background-color:#fff!important;">
                ...
                <div class="max-w-7xl col-span-1 md:col-span-3 relative px-2 md:px-3 mt-0 lg:mt-4">
    ...
    <div class="text-center my-8">
        <a class="block md:inline mx-2 bg-green-500 text-white py-3 px-8 rounded-md shadow-md" href="{{ route('brands.details.show', [$brand->slug]) }}">Seguir agregando al carrito</a>
    </div>

    {{-- Otros productos de la tienda --}}
    @include('tienda.other_products')
