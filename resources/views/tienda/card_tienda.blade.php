...
<article class="grid grid-cols-5 md:grid-cols-5 lg:grid-cols-6 p-1 md:p-3 lg:p-4 shadow-md bg-white mb-2 md:mb-4">
    <div class="col-span-1 self-center">
        <div class="bg-no-repeat bg-cover bg-center h-12 w-12 md:w-16 md:h-16 overflow-hidden rounded-full mx-auto" style="background-image: url('/storage/{{ $tienda->profile_photo_path_brand }}');"></div>
    </div>
    <div class="col-span-3 md:col-span-3 lg:col-span-4">
        ...
        <div>
            <span class="flex self-center text-xs md:text-sm text-gray-600">
                <svg class="inline h-4 md:h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#999"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
                <span class="inline font-semibold">
                    ...
                    @endisset
                    <span class="hidden md:inline"> {{ $tienda->address->address }} </span>
                </span>
            </span>
        </div>
        <div>
    ...
    <div class="col-span-1 lg:col-span-1 mx-auto self-center" >
        @if ( count($tienda->deliveries) > 0 )
                ...
                @if ( $delivery_free )
                    ...
                    <span class="block text-green-500 text-xs md:text-md">
                        Envíos Gratis
                    </span>
                @else
                    ...
                    <span class="block text-blue-500 text-xs md:text-md">
                        Envíos
                    </span>
