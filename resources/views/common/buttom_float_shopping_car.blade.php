<div class="fixed mb-1 right-3 mr-2 z-30" id="compareFloatButton">
    <a class="flex md:hidden h-11 w-11 self-center text-center bg-blue-600 rounded-full shadow-md items-center" href="{{ route('comparar') }}">
...
<div class="flex md:hidden fixed bottom-5 right-4 h-14 w-14 self-center text-center bg-green-500 rounded-full z-30 shadow-md items-center cursor-pointer shoppingCarButtonOpenModal" {{-- id="shoppingCarButtonFloatOpenModal" --}}>
