    ...
    <div class="px-2 grid grid-cols-4 md:grid-cols-6 gap-1">
        <div class="col-span-4 md:col-span-2 items-center md:text-left mb-8 md:mb-0">
            ...
            <div class="mt-3 text-center md:text-left">
                <a href="">
                    <img class="inline " src="{{ asset('icons/instagram.svg') }}" alt="">
                </a>
                <a href="">
                    <img class="inline ml-2" src="{{ asset('icons/facebook.svg') }}" alt="">
                </a>
            </div>
        </div>
        ...
        <div class="col-span-4 sm:col-span-2">
            ...
            <div class="">
                <img class="mx-auto md:mx-0" src="{{ asset('icons/appstore.svg') }}" alt="">
            </div>
            <div class="pt-3">
                <img class="mx-auto md:mx-0" src="{{ asset('icons/googleplay.svg') }}" alt="">
            </div>
        </div>
