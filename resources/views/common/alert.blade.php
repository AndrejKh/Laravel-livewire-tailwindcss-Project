...
>
    <div class="flex items-center justify-between flex-wrap px-2">
        ...
        <div class="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
            <button wire:click="$set('show_alert', 'false')" type="button" class="-mr-1 flex p-1 rounded-md hover:bg-{{$color_alert}}-700 focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2">
