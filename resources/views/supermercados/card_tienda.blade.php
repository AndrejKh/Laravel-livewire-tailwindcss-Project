    ...
    <div class="col-span-1 lg:col-span-1 mx-auto self-center" title="Envios Gratis">
        @if ( count($tienda->deliveries) > 0 )
                ...
                @if ( $delivery_free )
                    ...
                    <span class="block text-green-600 text-xs md:text-md"> <span class="hidden md:inline">Envíos</span> Gratis</span>
                @else
                    ...
                    <span class="block text-blue-600 text-xs md:text-md"> <span class="hidden md:inline">Envíos</span> Pagos </span>
        ...
        @else
            ...
            <span class="block text-gray-700 text-xs md:text-md">
