<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Agrega mayor seguridad a tu cuenta con la autenticación de dos factores.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                {{ __('Cuando la autenticación de dos factores está habilitada, se le solicitará un código aleatorio durante el inicio de sesión. Puede obtener este código de la aplicación "Google Authenticator" de su teléfono.') }}
            </p>
        </div>
