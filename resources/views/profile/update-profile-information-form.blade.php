<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-3 row-span-1 sm:col-span-2 sm:row-span-2">
        ...
        <!-- Name -->
        <div class="col-span-3 row-span-1 sm:col-span-4 sm:row-span-2">
