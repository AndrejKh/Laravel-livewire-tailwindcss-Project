<x-jet-action-section>
    <x-slot name="title">
        {{ __('Sesiones abiertas en otros dispositivos') }}
    </x-slot>

    <x-slot name="description">
        {{ __('Puedes administrar las sesiones abiertas en otros dispositivos.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario, puede cerrar la sesión de todas las demás sesiones en todos sus dispositivos.
                        ...
                        <div class="ml-3">
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @else
                                        {{ __('Última vez activa') }} {{ $session->last_active }}
                                    @endif
                                </div>
                            </div>
                        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Ingrese su contraseña para confirmar que desea cerrar la sesión en todos sus dispositivos.') }}
