<div>
    ...
    <div wire:click="SetModalShow()" class="flex fixed bottom-14 right-4 h-14 w-14 justify-center bg-green-500 rounded-full z-30 shadow-md items-center cursor-pointer">
