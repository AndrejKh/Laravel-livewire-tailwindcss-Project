    ...
    @if ( $brand )
        <div class="w-full shadow-md rounded-lg p-3 lg:p-6 bg-white">
            ...
            <div class="flex mb-2 align-self justify-between">
                ...
                @else
                    <x-jet-button wire:loading.attr="disabled" wire:click="buttonCreate">
                        Configurar
                    </x-jet-button>
                @endif
            ...
            <div class="grid grid-cols-2 mt-3">
                    ...
                    @if( $brand->address )
                        ...
                        <div class="col-span-1 pr-3">
                            <strong class="mr-2 text-gray-500">Estado:</strong>
                            <span>
                                {{ $brand->address->state_id ? $brand->address->state->state : 'Sin información' }}
                            </span>
                        </div>
                        <div class="col-span-1">
                            <strong class="mr-2 text-gray-500">Municipio:</strong>
                            <span>
                                {{ $brand->address->city_id ? $brand->address->city->city : 'Sin información' }}
                            </span>
                        </div>
                        <div class="col-span-2 pt-2">
                            <strong class="mr-2 text-gray-500">Dirección:</strong>
                            <span>
                                {{ $brand->address ? $brand->address->address : 'Sin información' }}
                            </span>
                        </div>
                    @else
        ...
        @else
            ...
            <x-jet-dialog-modal wire:model="openModal">
                <x-slot name="title">
                    La dirección principal de tu marca asdf
                </x-slot>
                ...
                <x-slot name="footer">
                    ...
                    <x-jet-button wire:loading.attr="disabled" wire:click="create">
                        Confirmar
                    </x-jet-button>
                </x-slot>
            </x-jet-dialog-modal>
