        ...
        <x-jet-dialog-modal wire:model="openModalActualizar">
            ...
            <x-slot name="content">
                <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                    ...
                    <div class="col-span-2 md:col-span-6 mb-0 md:mb-2">
                            <x-jet-label class="font-bold mb-2" value="Selecciona los días en que haces delivery" />
                            <input class="cursor-pointer" type="checkbox" wire:model.defer="days" value="lunes" id="lunes">
                            <label class="cursor-pointer mr-1" for="lunes">Lunes</label>
                            <input class="cursor-pointer" type="checkbox" wire:model.defer="days" value="martes" id="martes">
                            <label class="cursor-pointer mr-1" for="martes">Martes</label>
                            <input class="cursor-pointer" type="checkbox" wire:model.defer="days" value="miercoles" id="miercoles">
                            <label class="cursor-pointer mr-1" for="miercoles">Miércoles</label>
                            <input class="cursor-pointer" type="checkbox" wire:model.defer="days" value="jueves" id="jueves">
                            <label class="cursor-pointer mr-1" for="jueves">Jueves</label>
                            <input class="cursor-pointer" type="checkbox" wire:model.defer="days" value="viernes" id="viernes">
                            <label class="cursor-pointer mr-1" for="viernes">Viernes</label>
                            <input class="cursor-pointer" type="checkbox" wire:model.defer="days" value="sabado" id="sabado">
                            <label class="cursor-pointer mr-1 align-self" for="sabado">Sábado</label>
                            <input class="cursor-pointer" type="checkbox" wire:model.defer="days" value="domingo" id="domingo">
