    ...
    <div class="grid grid-cols-1 md:grid-cols-5 max-w-7xl">
        <div class="col-span-1 md:col-span-3 flex-1">
            <h2 class="text-xl">
                ...
                Configura tus zonas de delivery
            </h2>
            <small class="text-sm text-gray-500">
                Estas serán las zonas donde tus clientes podrán recibir sus compras. <br>
                 ¡Coloca un monto mínimo y ofrece envíos gratis a tus clientes!
            </small>
        </div>
        <div class="col-span-1 md:col-span-2 md:text-right mt-3 md:mt-0">
    ...
    <x-jet-dialog-modal wire:model="openModal">
        ...
        <x-slot name="content">
            <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                ...
                <div class="col-span-1 md:col-span-6 mb-0 md:mb-2">
                        ...
                        @foreach ($days_week as $day)
                            ...
                            <label class="cursor-pointer mr-1" for="{{ ucfirst($day->day) }}">{{ ucfirst($day->day) }}</label>
                        @endforeach
                        @error('days')
                            <small class="text-red-400 italic">{{$message}}</small>
                        @enderror
    ...
    @if ( $deliveries && count($deliveries) > 0)
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-2 px-0 py-2 lg:p-2 max-w-7xl">
            @foreach ($deliveries as $delivery)
                <div class="col-span-1 shadow-md rounded-xl p-3">
                    <div class="grid grid-cols-6">
                        ...
                        <div class="col-span-6 flex justify-between mt-2">
                            ...
                            <div>
                                <button class="inline" wire:loading.attr="disabled" wire:click="buttonActualizarBrand({{$delivery->id}})">
