<div class="col-span-1 mb-2 md:mb-0">
    <div class="w-full shadow-md rounded-lg p-3 lg:p-6 bg-white">
        ...
        <div class="grid grid-cols-2 mt-3">
                @if (!$direction)
                    <span class="text-gray-700">Esta dirección se mostrará como la principal de tu marca.</span>
                @else
                <div class="col-span-1 pr-3">
                    <strong class="mr-2 text-gray-500">Estado:</strong> <span> {{ $user->state->state }} </span>
                </div>
                <div class="col-span-1">
                    <strong class="mr-2 text-gray-500">Municipio:</strong>
                    <span>
                        {{ $user->city_id ? $user->city->city : 'Sin información' }}
                    </span>
                </div>
                <div class="col-span-2 pt-2">
                    <strong class="mr-2 text-gray-500">Dirección:</strong> <span> Urb. Araguaney, Av. Araguaney Urb. Araguaney, Av. Araguaney Urb. Araguaney, Av. Araguaney </span>
                </div>
                @endif
        </div>
